    ...
    function (t, e, s) {
        ...
        var i,
            ...
            r = (function () {
                ...
                return (
                    (t.prototype.init = function () {
                        var t = this,
                            e = $.extend({}, this._$el.position(), { height: this._$el[0].offsetHeight });
                        (this._dd = $("<ul />")),
                            this._dd.addClass("bootstrap-autocomplete dropdown-menu"),
                            this._dd.insertAfter(this._$el),
                            this._dd.css({ top: e.top + this._$el.outerHeight(), left: e.left, width: this._$el.outerWidth() }),
                        ...
                        (t.prototype.refreshItemList = function () {
                            ...
                            if (this.items.length > 0)
                                this.items.forEach(function (s) {
                                    ...
                                    var r = n.disabled,
                                        l = $("<a >");
                                    l.addClass("dropdown-item").css({ overflow: "hidden", "text-overflow": "ellipsis" }).html(o).data("item", s), r && l.addClass("disabled"), e.push(l);
                                }),
                                    this._dd.append(e),
                                    this.show();
            ...
            a = (function () {
                ...
                return (
                    (t.prototype.manageInlineDataAttributes = function () {
                        ...
                        (t.prototype.getBootstrapVersion = function () {
                            ...
                            "auto" === this._settings.bootstrapVersion
                                ? (t = $.fn.button.Constructor.VERSION.split(".").map(parseInt))
                                : "4" === this._settings.bootstrapVersion
                                ? (t = [4])
                                : "3" === this._settings.bootstrapVersion
                                    ? (t = [3])
                                    : (console.error("INVALID value for 'bootstrapVersion' settings property: " + this._settings.bootstrapVersion + " defaulting to 4"), (t = [4]));
                            return t;
                        }),
                        (t.prototype.convertSelectToText = function () {
                            ...
                            var s = $("<input>");
                            s.attr("type", "search"),
                                s.attr("name", this._$el.attr("name") + "_text"),
                                s.attr("id", this._$el.attr("id")),
                                s.attr("disabled", this._$el.attr("disabled")),
                                s.attr("placeholder", this._$el.attr("placeholder")),
                                s.attr("autocomplete", "off"),
                                s.addClass(this._$el.attr("class")),
                            this._defaultText && s.val(this._defaultText);
                        ...
                        (t.prototype.init = function () {
                            ...
                            "ajax" === this._settings.resolver && (this.resolver = new n(this._settings.resolverSettings)),
                                4 === this.getBootstrapVersion()[0]
                                    ...
                                    : (this._dd = new r(this._$el, this._settings.formatResult, this._settings.autoSelect, this._settings.noResultsText));
                        }),
                            ...
                            this._$el.on("keydown", function (e) {
                                switch (e.which) {
                                    case 9:
                                        ...
                                        break;
                                    case 13:
                                        t._dd.isItemFocused ? t._dd.selectFocusItem() : t._selectedItem || ("" !== t._$el.val() && t._$el.trigger("autocomplete.freevalue", t._$el.val())),
                                            t._dd.hide(),
                                        t._settings.preventEnter && e.preventDefault();
                                        break;
                                    case 40:
                                        t._dd.focusNextItem();
                                        break;
                                ...
                                this._$el.on("blur", function (e) {
                                    !t._dd.isMouseOver && t._dd.isDdMouseOver && t._dd.isShown()
                                        ? (setTimeout(function () {
                                            t._$el.focus();
                                        }),
                                            t._$el.focus())
                                        ...
                                        (t._isSelectElement
                                            ? t._dd.isItemFocused
                                                ? t._dd.selectFocusItem()
                                                : null !== t._selectedItem && "" !== t._$el.val()
                                                    ? t._$el.trigger("autocomplete.select", t._selectedItem)
                                                    : "" !== t._$el.val() && null !== t._defaultValue
                                                        ? (t._$el.val(t._defaultText), t._selectHiddenField.val(t._defaultValue), (t._selectedItem = null), t._$el.trigger("autocomplete.select", t._selectedItem))
                                                        : (t._$el.val(""), t._selectHiddenField.val(""), (t._selectedItem = null), t._$el.trigger("autocomplete.select", t._selectedItem))
                                            : null === t._selectedItem && t._$el.trigger("autocomplete.freevalue", t._$el.val()),
                                            t._dd.hide());
                                }),
                        ...
                        (t.prototype.handlerDoSearch = function () {
                            ...
                            null !== this._settings.events.search
                                ...
                                : this.resolver &&
                                this.resolver.search(this._searchText, function (e) {
                                    t.postSearchCallback(e);
                                });
                        }),
