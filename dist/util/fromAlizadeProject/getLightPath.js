...
const serverAddr1 = "http://45.139.10.150:80/api/v2.0.0/";
...
async function get_RWA_Path() {
    ...
    let result = await callService(`http://45.139.10.150:80/api/v2.0.0/algorithms/rwa/result?rwa_id=${rwa_id}`, requestOptions);
