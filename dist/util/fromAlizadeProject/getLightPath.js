...
const serverAddr1 = "http://0.0.0.0:5020/api/v2.0.0/";
...
async function get_RWA_Path() {
    ...
    let result = await callService(`http://0.0.0.0:5020/api/v2.0.0/algorithms/rwa/result?rwa_id=${rwa_id}`, requestOptions);
