...
async function getAllGrooming() {
  ...
  const request = {
    url: "http://0.0.0.0:5020/api/v2.0.1/algorithms/grooming/all",
    method: "GET",
    query: loadQuery,
    headers: {
      Accept: "application/json",
...
async function getAllClustring() {
  ...
  result = await callService(
    `http://0.0.0.0:5020/api/v2.0.0/clustering/manual/read_all?project_id=${project_id}`,
    requestOptions
  );
...
async function getRWA_general_info(rwa_id) {
  ...
  result = await callService(
    `http://0.0.0.0:5020/api/v2.0.0/algorithms/rwa/result?rwa_id=${rwa_id}`,
    requestOptions
  );
...
async function deleteClustring(Clusters) {
  ...
  swal({
    ...
    if (willDelete) {
      ...
      fetch(
        `http://0.0.0.0:5020/api/v2.0.0/clustering/?cluster_id=${ClusterId}`,
        requestOptions
      )
        .then((response) => response.text())
        .then((result) => console.log(result))
...
async function startEnd2EndGrooming() {
  ...
  result = await callService(
    `http://0.0.0.0:5020/api/v2.0.1/algorithms/automatic/end_to_end/read_all?project_id=${project_id}`,
    requestOptions
  );
...
function SubmitGroomingEndToEnd(project_id) {
  ...
  callService(
    `http://0.0.0.0:5020/api/v2.0.1/algorithms/grooming/automatic/end_to_end?project_id=${project_id}`,
    requestOptions
  );
...
function SubmitGroomingAdvanced(project_id) {
  ...
  callService(
    `http://0.0.0.0:5020/api/v2.0.1/algorithms/grooming/automatic/advanced?project_id=${project_id}`,
    requestOptions
  );
...
async function getStatisticalResult(groomingId) {
  ...
  result = await callService(
    `http://0.0.0.0:5020/api/v2.0.0/algorithms/grooming/result?grooming_id=${groomingId}`,
    requestOptions
  );
...
async function DeleteGrooming(groomingId) {
  ...
  result = await callService(
    `http://0.0.0.0:5020/api/v2.0.1/algorithms/grooming/result?grooming_id=${groomingId}`,
    requestOptions
  );
...
async function DeleteRWA(rwaId) {
  ...
  result = await callService(
    `http://0.0.0.0:5020/api/v2.0.1/algorithms/rwa/result?rwa_id=${rwaId}`,
    requestOptions
  );
...
async function Call_rwa_excel(RWA_Id) {
  ...
  let result = await fetch(`http://0.0.0.0:5020/api/v2.0.0/algorithms/rwa/result/excel?rwa_id=${RWA_Id}`, requestOptions)
    .then(response => {
...
async function Call_project_json(RWA_Id) {
  ...
  let result = await fetch(`http://0.0.0.0:5020/api/v2.0.1/algorithms/rwa/project_json?rwa_id=${RWA_Id}`, requestOptions)
    .then(response => {
      return response.blob();
    })
    .then(result => {
...
async function Call_Lom_excel(RWA_Id) {
  ...
  let url = `http://0.0.0.0:5020/api/v2.0.1/algorithms/rwa/lom_excel?rwa_id=${RWA_Id}`;
...
async function Call_Bpm_zip(RWA_Id) {
  ...
  let url = `http://0.0.0.0:5020/api/v2.0.1/algorithms/rwa/bpm_zip?rwa_id=${RWA_Id}`;
...
async function export_grooming_results() {
  ...
  if (grooming_id == undefined || grooming_id == null) {
    ...
    result = await callService(
      `http://0.0.0.0:5020/api/v2.0.0/algorithms/grooming/result?grooming_id=${grooming_id}`,
      requestOptions
    );
    // console.log(result)
    download(
...
async function export_full_details_xlsx() {
  ...
  if (rwa_id == undefined || rwa_id == null) {
    ...
    // result = await callService(`http://0.0.0.0:5020/api/v2.0.0/algorithms/rwa/result?rwa_id=b48a8220-a594-40ce-b83d-60795b3ca046`, requestOptions);
  ...
  //     };
  //     // result = await callService(`http://0.0.0.0:5020/api/v2.0.0/algorithms/rwa/result?rwa_id=b48a8220-a594-40ce-b83d-60795b3ca046`, requestOptions);
  //     result = await callService(`http://0.0.0.0:5020/api/v2.0.0/algorithms/rwa/result?rwa_id=${rwa_id}`, requestOptions);
  //     console.log(rwa_id);
  ...
  let funcA = async () => {
    if (a >= 100) {
      ...
      let grooming_result = await callService(
        `http://0.0.0.0:5020/api/v2.0.0/algorithms/grooming/check`,
        requestOptions
      );
